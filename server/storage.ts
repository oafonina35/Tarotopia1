...
export class MemStorage implements IStorage {
  ...
  private tarotCards: Map<number, TarotCard>;
  ...
  constructor() {
    ...
    // Initialize with Major Arcana cards
    this.initializeTarotCards();
  }

  private initializeTarotCards() {
    const majorArcana = [
      {
        name: "The Fool",
        arcana: "Major",
  ...
  async getCardReading(id: number): Promise<CardReading | undefined> {
    return this.cardReadings.get(id);
  }
