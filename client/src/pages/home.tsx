        ...
        <div className="max-w-md mx-auto">
          ...
          {scanningState === 'ready' && (
            <div className="text-center mb-8 -mt-4">
              <h2 className="text-2xl font-serif font-bold mb-2" style={{ color: 'hsl(180, 45%, 35%)' }}>Scan Your Tarot Card</h2>
              <p className="text-sm text-foreground mb-6 max-w-64 mx-auto">Reveal its mystical meanings and guidance</p>
            </div>
          )}
